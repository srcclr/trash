...
Make sure you're using go1.6 or later version.
 ...
 1. Download and extract [latest release](https://github.com/srcclr/trash/releases/latest) to your PATH.
    Alternatively, install or update current development version with `go get -u github.com/srcclr/trash`.
